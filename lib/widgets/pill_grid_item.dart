...
class PillsList extends StatelessWidget {
  const PillsList({
    super.key, required this.pill_list, required this.onRemovePill,
  });
 ...
 final void Function(pills Pill) onRemovePill;
  ...
  Widget build(BuildContext context) {
    ...
    availablePills.isEmpty? const Center(child: 
     ...
     Dismissible(key: ValueKey(pill_list[index]),
     onDismissed:(direction)=> onRemovePill(pill_list[index]),
     child: PillsScreen(title: pill_list[index].pillName, Pill_item: pill_list[index])
